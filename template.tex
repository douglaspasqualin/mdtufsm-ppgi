...
\usepackage{times, color}       % pacote para usar fonte Adobe Times e cores
...
\coadvisor[Prof.]{Dr.}{Pereira}{José}
...
%%=============================================================================
%Somente obrigatório para dissertação, para TG, remover a linha
%Na hora de gerar a catalogação na página da biblioteca da UFSM, colocar 1 página 
%a mais referente a própria catalogação
%\includeCIP{CIP.pdf}

%Somente obrigatório para dissertação, para TG, remover as linhas	77	%Somente obrigatório para dissertação, para TG, remover a linha
%Como a CIP vai ser impressa atrás da página de rosto, as margens inner e outer	78	%Na hora de gerar a catalogação na página da biblioteca da UFSM, colocar 1 página
%devem ser invertidas.	79	%a mais referente a própria catalogação
%\newgeometry{inner=20mm,outer=30mm,top=30mm,bottom=20mm}	
%\makeCIP		
  %{XXXX} %cutter		
  %{000.00} %CDU		
  %{Nome do Bibliotecário - CRB-99/999} %Bibliotecatório que fez a CIP		
  %{nomedoautor@gmail.com} %email do autor		
%\restoregeometry
\includeCIP{CIP.pdf}
